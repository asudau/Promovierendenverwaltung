...
class DoktorandenverwaltungAddFieldsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $query = "INSERT INTO `doktorandenverwaltung_fields` (`id`, `title`, `default`, `overview_position`, `group`, `group_position`, `fill`, `values`, `export`) 
           ...
           ('ef026', 'Art der Prüfung', NULL, NULL, 'abschlusspruefung', '4', 'manual_req', NULL, '1'),
           ('ef027', '1. Studienfach', NULL, NULL, 'abschlusspruefung', '5', 'manual_req', NULL, '1'),
           ('ef028', 'Monat des Prüfungsabschlusses', NULL, NULL, 'abschlusspruefung', '6', 'manual_req', NULL, '1'),
           ('ef029', 'Jahr des Prüfungsabschlusses', NULL, NULL, 'abschlusspruefung', '7', 'manual_req', NULL, '1'),
           ('ef030', 'Gesamtnote', NULL, NULL, 'abschlusspruefung', '8', 'manual_req', NULL, '1'),
