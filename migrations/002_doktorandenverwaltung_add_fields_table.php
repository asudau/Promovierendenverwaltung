...
class DoktorandenverwaltungAddFieldsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $query = "INSERT INTO `doktorandenverwaltung_fields` (`id`, `title`, `default`, `overview_position`, `group`, `group_position`, `fill`, `value_id`, `value_key`, `export_name`) 
           ...
           ('hzb_art', 'Art der HZB', NULL, NULL, 'hzb', '2', 'manual_req', 'entrance', 'astat_bund', 'ef032'),
           ('hzb_land', 'Bundesland', NULL, NULL, 'hzb', '3', 'manual_req', 'bundeslaender', 'astat_bund', 'ef033u1'),
           ('hzb_kreis', 'Kreis (bei Erwerb in Deutschland)', NULL, NULL, 'hzb', '4', 'manual_req', 'landkreise', 'his_id', '0'),
           ('hzb_staat', 'Staat (bei Erwerb im Ausland)', NULL, NULL, 'hzb', '5', 'manual_req', 'country', 'astat_bund', '0'),
