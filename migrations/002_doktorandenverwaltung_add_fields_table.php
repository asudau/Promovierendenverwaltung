...
class DoktorandenverwaltungAddFieldsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $query = "INSERT INTO `doktorandenverwaltung_fields` (`id`, `title`, `default`, `overview_position`, `group`, `group_position`, `fill`, `value_key`, `export`) 
           ...
           ('staatsangehoerigkeit', 'Staatsangehörigkeit', NULL, NULL, 'doktorandendaten', '8', 'manual_req', 'country', 'astat_bund', 'ef008'),
           ('weitere_staatsangehoerigkeit', 'Weitere Staatsangehörigkeit', NULL, NULL, 'doktorandendaten', '9', 'manual_opt', 'country', 'astat_bund', 'ef009'),
           ('art_promotion', 'Art der Promotion', NULL, NULL, 'promotionsdaten', '2', 'manual_req', NULL, 'his_id', 'ef010'),
           ('promotionsfach', 'Promotionsfach', NULL, '5', 'promotionsdaten', '3', 'manual_req', NULL, 'lid', 'ef011'),
           ('art_reg_prom', 'Art der Registrierung', NULL, NULL, 'promotionsdaten', '4', 'manual_req', 'candidate_status', 'astat_bund', 'ef012'),
           ...
           ('matrikelnummer', 'Matrikelnummer', NULL, NULL, 'promotionsdaten', '10', 'manual_opt', NULL, NULL, '0'),
           ('immatrikulation', 'Immatrikulation', NULL, NULL, 'promotionsdaten', '9', 'manual_req', NULL, 'his_id', 'ef015'),
           ...
           ('employment', 'Beschäftigungsverhältnis an der Hochschule der Promotion', NULL, NULL, 'promotionsdaten', '12', 'manual_req', 'employment', 'astat_bund', 'ef017'),
           ('art_dissertation', 'Art der Dissertation', NULL, NULL, 'promotionsdaten', '13', 'manual_req', NULL, 'his_id', 'ef018'),
           ('hochschule_erst', 'Hochschule', NULL, NULL, 'ersteinschreibung', '1', 'manual_req', 'university', 'astat_bund', 'ef019'),
           ('staat_hochschule_erst', 'Bei einer Hochschule ausserhalb Deutschlands, der Staat der Hochschule', NULL, NULL, 'ersteinschreibung', '2', 'manual_req', 'country', 'astat_bund', 'ef020'),
           ('semester', 'Semester', NULL, NULL, 'ersteinschreibung', '3', 'manual_req', NULL, 'his_id', 'ef021'),
           ...
           ('hochschule_abschlusspruefung', 'Hochschule der Abschlussprüfung', NULL, NULL, 'abschlusspruefung', '2', 'manual_req', 'university', 'astat_bund', 'ef024'),
           ('staat_abschlusspruefung', 'Staat', NULL, NULL, 'abschlusspruefung', '3', 'manual_req', 'country', 'astat_bund', 'ef025'),
           ('studienform_abschluss', 'Studienform', NULL, NULL, 'abschlusspruefung', '4', 'manual_req', NULL, 'his_id', '0'),
           ('abschlusspruefung_abschluss', 'Abschluss', NULL, NULL, 'abschlusspruefung', '5', 'manual_req', NULL, 'lid', '0'),
           ...
           ('hzb_jahr', 'Jahr des Erwerbs einer HZB', NULL, NULL, 'ersteinschreibung', '5', 'manual_req', NULL, NULL, 'ef031'),
           ('hzb_art', 'Art der HZB', NULL, NULL, 'ersteinschreibung', '6', 'manual_req', 'entrance', 'astat_bund', 'ef032'),
           ('hzb_land', 'Bundesland', NULL, NULL, 'ersteinschreibung', '7', 'manual_req', 'bundeslaender', 'his_id', 'ef033u1'),
