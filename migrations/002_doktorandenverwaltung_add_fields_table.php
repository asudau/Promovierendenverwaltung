...
class DoktorandenverwaltungAddFieldsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $query = "INSERT INTO `doktorandenverwaltung_fields` (`id`, `title`, `default`, `overview_position`, `group`, `group_position`, `fill`, `value_key`, `export`) 
           ...
           ('ef012', 'Art der Registrierung als Promovierender', NULL, NULL, 'promotionsdaten', '4', 'manual_req', 'his_id', '1'),
           ...
           ('ef015', 'Immatrikulation', NULL, NULL, 'promotionsdaten', '10', 'manual_req', 'his_id', '1'),
           ('ef016', 'Teilnahme an einem strukturierenden Promotionsprogramm', NULL, NULL, 'promotionsdaten', '11', 'manual_req', 'his_id', '1'),
           ('ef017', 'Beschäftigungsverhältnis an der Hochschule der Promotion', NULL, NULL, 'promotionsdaten', '12', 'manual_req', 'his_id', '1'),
           ('ef018', 'Art der Dissertation', NULL, NULL, 'promotionsdaten', '13', 'manual_req', 'his_id', '1'),
           ...
           ('studienform', 'Studienform', NULL, NULL, 'abschlusspruefung', '5', 'manual_req', 'his_id', '0'),
           ('abschluss', 'Abschlussprüfung', NULL, NULL, 'abschlusspruefung', '6', 'manual_req', 'lid', '0'),
