...
class DoktorandenverwaltungAddFieldsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $query = "INSERT INTO `doktorandenverwaltung_fields` (`id`, `title`, `default`, `overview_position`, `group`, `group_position`, `fill`, `value_id`, `value_key`, `export_name`) 
           ...
           ('immatrikulation', 'Immatrikulation', NULL, NULL, 'promotionsdaten', '9', 'manual_req', 'ja_nein', 'his_id', 'ef015'),
           ...
           ('staat_hochschule_erst', 'Bei einer Hochschule ausserhalb Deutschlands, der Staat der Hochschule', NULL, NULL, 'ersteinschreibung', '2', 'manual_req', 'country', 'his_id', 'ef020'),
